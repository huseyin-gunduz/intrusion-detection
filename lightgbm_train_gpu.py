...
# ===============================
# 2. ÇOK KÜÇÜK SINIFLARI KALDIR (LightGBM split hatası önle)
# ===============================
class_counts = df['Attack Type'].value_counts()
valid_classes = class_counts[class_counts >= 5].index  # En az 5 örnek
...
model = lgb.LGBMClassifier(
    ...
    max_depth=8,
    random_state=42,
    device='gpu',           # GPU varsa, yoksa CPU kullanılır
