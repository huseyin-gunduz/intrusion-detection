...
# ===============================
# 6. Random Forest MODELİ (CPU)
# ===============================
model = RandomForestClassifier(
    n_estimators=200,
    max_depth=8,
    random_state=42,
    n_jobs=-1,                # CPU'nun tüm çekirdeklerini kullanarak paralel çalışmasını sağla
...
clf_report = classification_report(y_test, y_pred,
                                   ...
                                   output_dict=True,
                                   zero_division=0)  # Precision için sıfır bölme hatalarını engelle
...
# ===============================
# 10. Sonuçları ekrana yazdır ve kaydet
# ===============================
# Basit metrikler ekrana yazdır
print("\n========== Model Özeti ==========")
...
print("\n--- Precision-Recall AUC (her sınıf için) ---")
